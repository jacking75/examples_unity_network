...
namespace LobbyServer
{
    public class PKHCommon : PKHandler
    {
        ...
        {            
            ...
            packetHandlerMap.Add((int)CL_PACKET_ID.REQ_LOBBY_LOGIN, RequestLogin);
        }
        ...
        public void NotifyInConnectClient(ServerPacketData requestData)
        {
            ...
            {
                LobbyServer.MainLogger.Error($"Fail AddUser. NetSessionID: {requestData.SessionID}");
            ...
            LobbyServer.MainLogger.Debug($"AddUser. NetSessionID: {requestData.SessionID}");
            return;
        }
        ...
        public void RequestLogin(ServerPacketData packetData)
        {
            ...
            LobbyServer.MainLogger.Debug("로그인 요청 받음");
            ...
            try
            {
                ...
                LobbyServer.MainLogger.Debug("로그인 완료");

            }
            catch(Exception ex)
            {
                // 패킷 해제에 의해서 로그가 남지 않도록 로그 수준을 Debug로 한다.
                LobbyServer.MainLogger.Debug(ex.ToString());
            }
        }
        ...
        void ResponseLoginToClient(ERROR_CODE errorCode, string sessionID)
        {
            ...
            ServerNetwork.SendData(sessionID, (UInt16)CL_PACKET_ID.RES_LOBBY_LOGIN, resLogin.ToBytes());
        }             
